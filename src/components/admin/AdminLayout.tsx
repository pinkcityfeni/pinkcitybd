...
import { LayoutDashboard, Package, ShoppingCart, BarChart3, Users, Warehouse, FolderTree, ScanBarcode, Store, ChevronLeft, ChevronRight, LogOut, Menu, X, Image, Star, Globe, Facebook, Sparkles, Tag, Ticket, Truck, Home, MessageCircle } from 'lucide-react';
...
const NAV_KEYS = [
  ...
  { to: '/admin/notifications', key: 'admin.notifications' as const, icon: MessageCircle },
];
