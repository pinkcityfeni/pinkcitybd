    ...
    <div className="container mx-auto px-4 py-6 animate-fade-in">
      ...
      <div className="grid lg:grid-cols-3 gap-4">
            ...
            return (
              <div key={item.product.id} className="rounded-xl border bg-card p-3 flex items-center gap-3">
                ...
                <div className="flex flex-col items-end gap-2">
                  <button onClick={() => removeFromCart(item.product.id)} className="p-1.5 rounded-lg text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-colors">
        ...
        <div className="rounded-xl border bg-card p-4 h-fit space-y-3">
          ...
          <Button asChild className="w-full rounded-lg h-11 font-semibold" size="lg">
